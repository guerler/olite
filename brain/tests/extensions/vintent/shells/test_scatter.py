import pytest
from olite.registry.extensions.vintent.modules.shells.base import ShellError
from olite.registry.extensions.vintent.modules.shells.scatter import ScatterShell
